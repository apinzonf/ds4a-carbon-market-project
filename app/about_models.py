...
For this reason, LSTM and CNN layers are often combined when forecasting a time series. This allows for the LSTM layer to account for sequential dependencies in the time series, while the CNN layer further informs this process through the use of dilated convolutions.""",
                        ...
                        html.A("""More info""",href="https://towardsdatascience.com/cnn-lstm-predicting-daily-hotel-cancellations-e1c75697f124"),
                        html.Br(),
                        html.Br(),
                        html.Br()
                    ],
                    ...
                    html.Section(children=[
                        ...
                        html.P("""In machine learning, Support Vector Machines are supervised learning models with associated learning algorithms that analyze data used for classification and regression analysis. In Support Vector Regression, the straight line that is required to fit the data is referred to as hyperplane.""",
                            className="card-text"),
                        html.A("""More info""",href="https://towardsdatascience.com/unlocking-the-true-power-of-support-vector-regression-847fd123a4a0"),
                        html.Br(),
                        html.Br(),
                        html.Br()
                    ],
